...
static void ggml_vec_dot_turbo4_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_vilenkin_3_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                         const void * GGML_RESTRICT vx, size_t bx,
                                         const void * GGML_RESTRICT vy, size_t by, int nrc);
...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_VILENKIN_3] = {
        .from_float               = (ggml_from_float_t) quantize_row_vilenkin_3_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_vilenkin_3_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
};
...
// Vilenkin3 vec_dot: dequantize to f32, then dot.
static void ggml_vec_dot_vilenkin_3_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                         const void * GGML_RESTRICT vx, size_t bx,
                                         const void * GGML_RESTRICT vy, size_t by, int nrc) {
    GGML_ASSERT(nrc == 1);
    ...
    float tmp[4096];
    GGML_ASSERT(n <= 4096);
    ggml_get_type_traits(GGML_TYPE_VILENKIN_3)->to_float(vx, tmp, n);
